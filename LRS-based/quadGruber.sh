...
/home/nike/qcone 5 2 ${f0} ${f1} ${f2} ${f3} ${f4} ${f5} ${f6} ${f7} ${f8} ${f9} ${f10} ${f11} ${f12} ${f13} ${f14} ${f15} ${f16} ${f17} ${f18} ${f19} ${f20} ${f21} ${f22} ${f23} ${f24} ${f25} ${f26} ${f27} ${f28} ${f29} ${f30} ${f31} --lrs > temp_${CASENO}.ine
/home/nike/lrslib-070-32bit/lrs < temp_${CASENO}.ine > temp_${CASENO}.ext
awk '{ if ($1==1) print$0 } END { print "$" }' < temp_${CASENO}.ext > temp_${CASENO}.vtx0
...
/home/nike/isquad temp_${CASENO} < temp_${CASENO}.vtx
>>>>>>> 1047a0bdd9fcde6ec9173fef0f1d30c5cd13f910:LRS-based/quadGruber.sh
